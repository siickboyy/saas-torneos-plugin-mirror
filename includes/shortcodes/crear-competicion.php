<?php
/**
 * Shortcode: [formulario_crear_competicion]
 * Renderiza el formulario de creación de competición en una página pública
 */

function str_shortcode_formulario_crear_competicion() {
    ...
    echo '<!-- [STR] Shortcode formulario_crear_competicion ejecutado correctamente -->';
    ?>

    <div class="str-dashboard-form">
        <button class="str-btn-cerrar" onclick="window.history.back();">✖</button>
...
add_shortcode('formulario_crear_competicion', 'str_shortcode_formulario_crear_competicion');
